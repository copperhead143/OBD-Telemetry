...
/*static const uint8_t drive_mode_data[5][8] = {
    [CMD_MODE_NORMAL] = {0x420, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
    [CMD_MODE_SPORT]  = {0x420, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
    [CMD_MODE_TRACK]  = {0x420, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
    [CMD_MODE_DRIFT]  = {0x420, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
};
